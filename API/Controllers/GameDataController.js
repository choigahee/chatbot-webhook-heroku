...
exports.processRequest = function (req, res) {
    ...
    function getTeamInfo(req, res) {
        console.log("getTeamInfo req, " + req.body.result.action);
    ...
    function getTeamSchedule(req, res) {
        console.log("getTeamSchedule req, " + req.body.result.action);
        let parameters = req.body.result.parameters;
        if (parameters.team1 == "") {
            let game_occurence = parameters.game_occurence;
            let team = parameters.team;
            console.log("game_occurence" + game_occurence + "team " + team);
            if (game_occurence == "previous") {
                ...
                GameSchedule.find({
                    ...
                    if (games) {
                        ...
                        return res.json({
                            speech: 'game list is 0',
                            displayText: 'game list is 0',
                            source: 'game schedule'
                        });
                    }
                });
